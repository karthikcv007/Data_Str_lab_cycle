...
void BinarySearchTree::insert(int key) { root = insertNode(root, key); }
...
void BinarySearchTree::remove(int key) { root = deleteNode(root, key); }
...
void BinarySearchTree::inOrder() { inOrderTraversal(root); }
